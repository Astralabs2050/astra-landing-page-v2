  ...
  return (
    <section className="text-center bg-black mb-20 lg:mb-[120px] bg-[url('/images/line-patterns.png')] bg-contain h-full w-full -mt-[120px] lg:-mt-[80px] pt-[39px] bg-no-repeat">
      <div className="px-10 lg:px-0">
        <motion.h1
          className="font-conthrax text-[28px] lg:text-[65px] leading-[32.03px] lg:leading-[82px] tracking-[-1.17px] lg:tracking-[-3px] max-w-[360px] lg:max-w-[850px] text-center mx-auto mt-[150px] lg:mt-[225px] text-shadow-futuristic"
