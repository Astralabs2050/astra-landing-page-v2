  ...
  ({ className, type, label, id, prepend, ...props }, ref) => {
    ...
    return (
      <div className="grid gap-2">
        ...
        {prepend ? (
          <React.Fragment>
            <div className="flex h-12 w-full items-center gap-2 rounded-md border border-input bg-background px-3 py-2 ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-0">
              {prepend} {input}
            </div>
          </React.Fragment>
        ) : (
