  ...
  const analytics = [
    {
      ...
      resultNumber: '3084',
      data: [3084, 1500, 1800, 2000, 2500, 3000],
    },
    {
      id: 2,
      title: 'Views this month',
      resultNumber: '8235',
      data: [8235, 4500, 3000, 4000, 5000, 6000],
    },
  ]
      ...
      <div className="mt-[60px] flex items-center justify-center gap-[40px]">
        <div className="flex gap-[40px]">
          {analytics.map(stat => (
            <div
              key={stat.id}
              className="flex w-[347px] justify-between rounded-[10px] border p-[30px]">
              <div>
                <p className="mb-[20px]">{stat.title}</p>
                <p className="text-[32px] font-[600]">{stat.resultNumber}</p>
              </div>
              <div className="mt-[50px]">graphics</div>
            </div>
          ))}
        </div>
